      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(5.0), // Уменьшение радиуса скругления
          ),
        ),
        child: const Text("Зарегистрировать", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
      ),
    );
  }
